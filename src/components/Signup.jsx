      ...
      <fieldset>
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="google"
            defaultChecked={formState.enteredValues?.acquisitionChannel?.includes('google') || false}
          />
        ...
        <div className="control">
          <input
            ...
            name="acquisition"
            value="friend"
            defaultChecked={formState.enteredValues?.acquisitionChannel?.includes('friend') || false}
          />
